...
| [`reorganize-branch-commits`](skills/reorganize-branch-commits/SKILL.md)     | Interactively rebases a non-default branch into a clean, logical history — proposes groupings from the actual diffs, gets approval, backs up, then rewrites while preserving signing and running hooks.      |
